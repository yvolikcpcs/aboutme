export const experiences = [
  ...
  {
    company: "Stanwood (Berlin, Germany)",
    role: "Frontend Developer",
    period: "2018 — 2019",
    description: "Digital Product Studio working for Funke Mediengruppe.",
    projects: [
      {
...
export const education = [
  {
    institution: "Sumy State University, Ukraine",
...
export const languages = [
  { name: "English", level: "Upper-Intermediate (B2) - Daily working language" },
  { name: "German", level: "Pre-Intermediate (A2) - Currently attending intensive courses" },
